...
const HeroSection = () => {
  ...
  const features = [
    ...
    { title: "سوم رمزي اقتصادي", sub: "جدّية اكثر ", icon: <Banknote size={20} />, color: "text-emerald-600", bg: "bg-emerald-50" },
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end animate-fade-in-up">
            <div className="relative w-full max-w-[500px] aspect-square group">
              <div className="absolute inset-0 z-10 bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl p-2 border border-slate-100 dark:border-slate-800 transition-all duration-500 group-hover:shadow-3xl">
                <Image
                  src="/hero-v2.png" 
                  alt="خدّمني"
                  fill 
          ...
          <div className="w-full lg:w-1/2 space-y-8 animate-fade-in-up animation-delay-200">
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 px-4 py-1.5 rounded-full border border-blue-100 dark:border-blue-800/50 hover:scale-105 transition-transform duration-300">
                ...
                <span className="text-[11px] font-bold uppercase tracking-widest leading-none">
                  فضاء التلاقي بين أصحاب العمل وطالبي الشغل
                </span>
              </div>
              <div className="flex items-center gap-2 text-slate-500 font-bold text-sm px-1">
                ...
                <span>تونس تجمعنا.. من بنزرت لبن قردان</span>
              </div>
            </div>
            ...
            {/* الفئات المستهدفة (Tags) مع animations */}
            ...
            {/* المميزات (Features) - 6 عناصر في شبكة 2x3 */}
