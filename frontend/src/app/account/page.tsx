...
import { Settings, ShieldCheck, Layout, Zap, User } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between px-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              {/* Profile Control -> التحكم في الحساب */}
        ...
        {/* Footer Modified with Arabic Security Note */}
